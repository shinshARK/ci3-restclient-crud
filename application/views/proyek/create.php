...
<body>
    ...
    <form action="<?php echo site_url('proyek/create'); ?>" method="post">
        ...
        <input type="text" name="namaProyek" id="namaProyek" required><br>

        <label for="client">Client:</label>
        <input type="text" name="client" id="client" required><br>

        <label for="tglMulai">Start Date:</label>
        <input type="date" name="tglMulai" id="tglMulai" required><br>

        <label for="tglSelesai">End Date:</label>
        <input type="date" name="tglSelesai" id="tglSelesai" required><br>

        <label for="pimpinanProyek">Project Leader:</label>
        <input type="text" name="pimpinanProyek" id="pimpinanProyek" required><br>
